...
,
		"rect" : [ 362.0, 44.0, 640.0, 480.0 ],
		"bglocked" : 0,
		"defrect" : [ 362.0, 44.0, 640.0, 480.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 185.0, 161.0, 53.0 ],
					"text" : "/Users/ianhattwick2/Dropbox/filepath_test/Contents/blah.txt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 450.0, 340.0, 46.0, 23.0 ],
					"text" : "text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 355.0, 145.0, 41.0, 21.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.0, 55.0, 458.0, 37.0 ],
					"text" : "replace /Users/ianhattwick2/Dropbox/filepath_test/Contents/violin_pizz_Ab3.wav"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 150.0, 58.0, 21.0 ],
					"text" : "read $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 220.0, 326.0, 23.0 ],
					"text" : "sprintf symout %sfilepath_test/violin_pizz_Ab3.wav"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 295.0, 430.0, 54.0, 149.0 ],
					"text" : "\"/Users/ianhattwick2/Dropbox/ Max Dropbox/AUMI/working files/\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 280.0, 365.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.0, 400.0, 140.0, 23.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 60.0, 312.0, 114.0, 20.0 ],
									"text" : "v APP_PLATFORM"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 60.0, 289.0, 121.0, 20.0 ],
									"text" : "v APP_ROOT_PATH"
								}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 43.0, 204.5, 139.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 186.0, 182.5, 123.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 186.0, 204.5, 122.0, 20.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 60.0, 182.5, 121.0, 20.0 ],
													"text" : "v APP_ROOT_PATH"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 94.0, 125.0, 192.0, 32.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 77.0, 162.0, 200.0, 32.0 ],
									"text" : ";\rmax getsystem APP_PLATFORM_r"
								}
...
,
					"patching_rect" : [ 390.0, 305.0, 49.0, 23.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"globalpatchername" : "",
						"fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 320.0, 79.0, 23.0 ],
					"saved_object_attributes" : 					{
						"statusvisible" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 245.0, 140.0, 85.0, 23.0 ],
					"text" : "buffer~ blah"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 245.0, 56.0, 21.0 ],
					"text" : "read $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 310.0, 50.0, 21.0 ],
					"text" : "clear"
				}
